...
## Contruct here--->>>
      ...
      public function Products_Category(){
        $tablename="service";  
          if($this->input->post('serviceName'))
          {
                ...
                $this->load->model('AdminModel');
        		$result = $this->AdminModel->insertTable($data,$tablename);
		  }
          ...
          if(!empty($result))
        {
           ...
           $product['AboutSection'] = $this->AdminModel->getTable($tablename);
	...
	public function deleteItem()
	    {
	$item = $this->input->post('option');
	$where = 'id';
	$tablename = "service";
	$this->AdminModel->deleteItem($where,$item,$tablename);
	echo $item;
	    }
...
redirect(base_url().'Admin_control/Products_Category');
     ...
     ## add_blog     
		...
		$this->load->view('admin/footer');
	        ...
	        {  
	            $tablename="corevalue";
                $data['row'] = $this->AdminModel->getTable($tablename);
		        $this->load->view('admin/corevalue',$data);
		        $this->load->view('admin/footer');
          ...
          public function addcorevalue(){
              $tablename="corevalue";
		  	 ...
		  	 if(move_uploaded_file($_FILES["addBlogimage"]["tmp_name"],'./images/'.$addBlogimage)){
		  	  ...
		  	  $this->AdminModel->corevalue($addBlogName,$addBlogimage,$addBlogmsg);
		  	 echo "<script>alert('Added !');</script>";
		  	 
     	 redirect(base_url().'Admin_control/corevalue');;
          }
    ...
    public function addServices(){
        $data['serviceName']=$this->input->post('name');
        $data['text']=$this->input->post('text');
        $data['img']  = $_FILES['img']['name'];
		 if(move_uploaded_file($_FILES["img"]["tmp_name"],'./images/icon/'.$data['img'])){
		  	     
		  	 }
        $tablename="service";
        $this->AdminModel->insertTable($data,$tablename);
         echo "<script>alert('Added !');</script>";
    ...
    public function editService(){
         ...
         $id=$this->input->post('id');
    //   echo $id;
       $allData['serviceName']=$this->input->post('name');
    //   $allData['subTitle']=$this->input->post('subTitle');
       $allData['text']=$this->input->post('text');
