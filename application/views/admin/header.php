    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!--</li>-->
             ...
             <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url();?>Admin_control/add_services" 
                    <span>Add services </span>
                </a>
            </li>
             <li class="nav-item">
             <a class="nav-link collapsed" href="<?php echo base_url();?>Admin_control/contact">Add Contact Details</a>
             </li>
             
              <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo base_url();?>Admin_control/add_about_us">About us</a>
             </li>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url();?>Admin_control/add_blog">Add Blogs</a>
                         ...
                         <a class="collapse-item" href="<?php echo base_url();?>Admin_control/corevalue">Add Core Value</a>
