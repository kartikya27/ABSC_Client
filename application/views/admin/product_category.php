              ...
              <form action="<?php echo base_url();?>Admin_control/Products_Category" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="serviceName" class="form-control" id="exampleInputMEnu" placeholder="Enter Service Name">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" name="text" class="form-control" placeholder="Enter Service details"></textarea>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <?php foreach($AboutSection as $AboutSection){ ?>
                            <option value="<?php echo $AboutSection->id; ?>" ><?php echo $AboutSection->serviceName; ?></option>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> 
 ...
 $("#delete_category").change(function() {
  ...
  // Delete it!
   $.ajax({
            url:'<?php echo base_url();?>Admin_control/deleteItem',
            method:"POST",
            data:{
            option:option
          },
