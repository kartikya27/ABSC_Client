...
foreach($row as $r){
           ...
           ?> 
                        ...
                        <tr> 
                        <td><img src="<?php echo base_url(); ?>images/icon/<?php echo $r->img; ?>" style="height:80px; width:80px;" /></td>
                      ...
                      <td class="text-center"><a  data-toggle="modal" data-target="#edit<?php echo $r->id;?>" class="btn btn-primary btn-xs"> Edit </a></td>
                        ...
                        <td class="text-center"><button class="btn btn-danger btn-xs" onclick="deleteSingle(<?php echo $r->id;?>,'service')">Delete</button></td>
                    </tr> 
                        ...
                        <div class="form-group">
                                <!--<label>Id</label>-->
                                 <input type="hidden" name="id" class="form-control"  value="<?php echo $r->id; ?>" readonly>
                                  ...
                                  <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" class="form-control" value="<?php echo $r->serviceName; ?>">
                            </div>
                            <div class="form-group">
                                <label>Image</label>
